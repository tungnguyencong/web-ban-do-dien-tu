...
if (isset($_SESSION['isLogin_Admin']) && $_SESSION['isLogin_Admin'] == true) {
    ...
    switch ($mod) {
        ...
        case 'banner':
           ...
           case 'logo':
            require_once('MVC/controllers/LogoController.php');
            $controller_obj = new LogoController();
            switch ($act) {
                case 'list':
                    $controller_obj->list();
                    break;
        ...
        case 'nguoidung':
            ...
            break;
             ...
             case 'tintuc':
            require_once('MVC/controllers/TinTucController.php');
        ...
        case 'khuyenmai':
            ...
            break;
           case 'footer':
            require_once('MVC/controllers/FooterController.php');
            $controller_obj = new FooterController();
            switch ($act) {
                case 'list':
                    $controller_obj->list();
                    break;
        ...
        case 'hoadon':
            ...
            break;
         case 'menu':
            require_once('MVC/controllers/MenuController.php');

            $controller_obj = new MenuController();
            switch ($act) {

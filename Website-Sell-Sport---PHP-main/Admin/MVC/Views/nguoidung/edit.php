        ...
        <input type="hidden" name="MaND" value="<?= $data['MaND']?>">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" id="" placeholder="" name="Tinh" value="<?= $data['Tinh']?>">
           </div>
           
            <div class="form-group">
               <label for="">Quận Huyện</label>
               <input type="text" class="form-control" id="" placeholder="" name="QuanHuyen" value="<?= $data['QuanHuyen']?>">
           </div>

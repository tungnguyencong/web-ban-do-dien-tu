...
<head>
  ...
  <title>Quản Trị WIRO SHOP</title>
                ...
                if (isset($_SESSION['isLogin_Admin']) && $_SESSION['isLogin_Admin'] == true) {
                  ...
                  switch ($mod) {
                    case 'khuyenmai':
                      ...
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/footer/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/footer/add.php');
                          break;
                        case 'detail':
                          require_once('MVC/views/footer/detail.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/footer/edit.php');
                          break;
                        default:
                          require_once('MVC/views/footer/list.php');
                          break;
                      ...
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/tintuc/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/tintuc/add.php');
                          break;
                        case 'detail':
                          require_once('MVC/views/tintuc/detail.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/tintuc/edit.php');
                          break;
                        default:
                          require_once('MVC/views/tintuc/list.php');
                          break;
                    ...
                    case 'banner':
                      ...
                      switch ($act) {
                        case 'list':
                          require_once('MVC/views/logo/list.php');
                          break;
                        case 'add':
                          require_once('MVC/views/logo/add.php');
                          break;
                        case 'detail':
                          require_once('MVC/views/logo/detail.php');
                          break;
                        case 'edit':
                          require_once('MVC/views/logo/edit.php');
                          break;
                        default:
                          require_once('MVC/views/logo/list.php');
                          break;
                    ...
                    case 'menu':
                      switch ($act) {
                        case 'list':
                          require_once('MVC/Views/menu/list.php');
                          break;
                         case 'add':
                          require_once('MVC/Views/menu/add.php');
                          break; 
                         case 'edit':
                          require_once('MVC/views/menu/edit.php');
                          break;   
                        default:
                           require_once('MVC/Views/menu/list.php');
                          break;

...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
  ...
  <div class="sidebar-brand-text mx-3">QHT <sup>Shop</sup></div>
</a>
...
<li class="nav-item">
  <a class="nav-link" href="?mod=tintuc">
    <i class="fas fa-fw fa-table"></i>
    <span>Quản lý tin tức</span></a>
</li>
<li class="nav-item">
  <a class="nav-link" href="?mod=menu">
    <i class="fas fa-fw fa-table"></i>
    <span>Quản lý Menu</span></a>
</li>
<li class="nav-item">
  <a class="nav-link" href="?mod=footer">
    <i class="fas fa-fw fa-table"></i>
    <span>Quản lý Footer</span></a>
</li>
<li class="nav-item">
  <a class="nav-link" href="?mod=logo">
    <i class="fas fa-fw fa-table"></i>
    <span>Quản lý Logo</span></a>
</li>

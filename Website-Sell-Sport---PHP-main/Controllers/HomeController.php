...
class HomeController
{
    ...
    function list()
    {
        ...
        $data_banner = $this->home_model->banner(0,3);

       

        $data_blog=$this->home_model->blog(0,4);

        $data_sanpham1 = $this->home_model->sanpham_danhmuc(0,12,1);
        $data_sanpham2 = $this->home_model->sanpham_danhmuc(0,8,2);
        $data_sanpham3 = $this->home_model->sanpham_danhmuc(0,8,3);

        $data_menu=$this->home_model->menu(0,5);
         $data_menu1=$this->home_model->menu(5,5);

         $data_logo=$this->home_model->logo();
